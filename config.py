...
# ── Solr Connection ────────────────────────────────────────────────────────────
SOLR_URL = "http://192.168.1.80:8983/solr/documents"   # Change to your core/collection URL
...
FIELD_OCR       = "ocr_content"           # OCR-scanned pages/images
...
QUERY_FIELDS = {
    ...
    "ocr_content":         0.6,  # OCR text — noisy, lower trust
    "author":              2.0,
    "file_path":           1.0,
}

# ── Facet Fields ───────────────────────────────────────────────────────────────
FACET_FIELDS = [FIELD_LANGUAGE, FIELD_FILE_TYPE]
